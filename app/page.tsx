    ...
    <div className="flex min-h-screen flex-col bg-background font-sans selection:bg-primary/20">
        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              asChild
              size="sm"
              className="rounded-full px-6 font-semibold shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all"
            >
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-24 pb-20 sm:pt-32 sm:pb-24 lg:pb-32">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Badge
              variant="outline"
              className="mb-6 rounded-full border-primary/20 bg-primary/5 px-4 py-1.5 text-sm font-medium text-primary animate-fade-in"
            >
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground mb-10 leading-relaxed">
              Transforma tu hobby en una inversión rentable. Gestiona tu capital
              con interés compuesto, define metas financieras y visualiza tu
              éxito con BetTracker Pro.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up">
              <Button
                asChild
                size="lg"
                className="h-12 rounded-full px-8 text-base shadow-xl shadow-primary/20 transition-transform hover:scale-105"
              >
                <Link href="/login">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-12 rounded-full px-8 text-base border-primary/20 hover:bg-primary/5"
              >
            ...
            <div className="mt-16 sm:mt-24 relative mx-auto max-w-5xl rounded-2xl border border-border/50 bg-background/50 shadow-2xl backdrop-blur-sm p-2 lg:p-4 animate-scale-in">
              <div className="rounded-xl overflow-hidden bg-muted/20 border border-border/30 aspect-[16/9] relative grid place-items-center group">
                <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent z-10 flex items-end justify-center pb-20">
                  <p className="text-muted-foreground font-medium bg-background/80 backdrop-blur px-4 py-2 rounded-full border border-border/50">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Olvídate de Excel. BetTracker Pro centraliza tu gestión de
                banca, seguimiento de metas y análisis en una sola plataforma
                moderna.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="mx-auto max-w-3xl text-center bg-background border border-border rounded-3xl p-10 shadow-2xl">
              <h2 className="text-3xl font-bold mb-6">
                Únete a la élite de apostadores
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                Deja de ser un espectador y conviértete en el dueño de tus
                resultados. La herramienta que usan los profesionales ya está
                disponible para ti.
              </p>
              <ul className="grid sm:grid-cols-2 gap-4 text-left mb-10 max-w-lg mx-auto">
                {[
                  "Gestión de banca automatizada",
                  "Seguimiento de metas ilimitado",
                  "Soporte prioritario",
              ...
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto h-14 rounded-full px-10 text-lg shadow-xl shadow-primary/25 hover:scale-105 transition-all"
              >
                <Link href="/login">Empezar Ahora - Es Gratis</Link>
              </Button>
              <p className="mt-4 text-sm text-muted-foreground">
                No se requiere tarjeta de crédito para el plan Free.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-border bg-background py-12">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          ...
          <p className="text-xs mt-6 max-w-lg mx-auto text-muted-foreground/70">
            ⚠️ Las apuestas deportivas conllevan riesgos. Juega con
            responsabilidad. Si necesitas ayuda, visita{" "}
            <a
